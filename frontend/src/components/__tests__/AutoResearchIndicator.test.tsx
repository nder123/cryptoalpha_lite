...
const baseEntry: ServiceHealthEntry = {
    status: 'active',
...
describe('AutoResearchIndicator', () => {
    it('renders nothing when entry is undefined', () => {
        const { container } = render(<AutoResearchIndicator entry={undefined} />);
        expect(container).toBeEmptyDOMElement();
    });

    it('renders collapsed summary with status badge', () => {
        render(<AutoResearchIndicator entry={baseEntry} />);
